...
const DEFAULT_GLOW_COLOR = "0, 168, 132";
...
export const healthHaloBentoCards: BentoCard[] = [
  {
    color: "#0a1210",
    title: "Live Vitals",
    description: "Real-time heart rate, SpO₂, and waveform monitoring",
    label: "Monitoring",
  },
  {
    color: "#0a1210",
    title: "Patient Portal",
    description: "Secure access for patients and families",
    label: "Access",
  },
  {
    color: "#0a1210",
    title: "AI Surveillance",
    description: "Fall, bed-exit, and motion detection",
    label: "Intelligence",
  },
  {
    color: "#0a1210",
    title: "ICU Dashboard",
    description: "Centralized view for clinical staff",
    label: "Overview",
  },
  {
    color: "#0a1210",
    title: "Smart Alerts",
    description: "Instant escalation to doctors and families",
    label: "Safety",
  },
  {
    color: "#0a1210",
    title: "Medications",
    description: "Compliance tracking and dose reminders",
    label: "Care",
  },
];
