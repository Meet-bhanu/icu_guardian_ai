...
const healthMetrics = [
  { label: "Overall Recovery", value: 72, color: "#22c55e" },
  { label: "Vital Stability", value: 85, color: "#3b82f6" },
    ...
    <AppLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Historical health analytics — John Smith (P001)</p>
        </div>
