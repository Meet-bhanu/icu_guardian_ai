...
export default function LiveMonitoringPage() {
  ...
  useEffect(() => {
    const id = setInterval(() => {
      ...
      setDiastolicBP((bp) => Math.round(Math.min(120, Math.max(50, bp + (Math.random() - 0.5) * 4))));
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <Card className={cn("p-5", vitalEval.isCritical && "border-red-500 ring-2 ring-red-300")}>
            ...
            <div className="space-y-4">
              <div className={cn("p-4 rounded-xl border", vitalEval.statuses.heartRate === "critical" ? "bg-red-100 border-red-300" : "bg-red-50 border-red-100")}>
              ...
              <div className={cn("p-4 rounded-xl border", vitalEval.statuses.spO2 === "critical" ? "bg-red-100 border-red-300" : "bg-blue-50 border-blue-100")}>
                <div className="flex items-center gap-2 mb-2">
              ...
              <div className={cn("p-4 rounded-xl border", vitalEval.statuses.systolicBP === "critical" ? "bg-red-100 border-red-300" : "bg-green-50 border-green-100")}>
                <div className="flex items-center gap-2 mb-2">
              ...
              <div className={cn("p-4 rounded-xl border", vitalEval.statuses.respiratoryRate === "critical" ? "bg-red-100 border-red-300" : "bg-orange-50 border-orange-100")}>
                <div className="flex items-center gap-2 mb-2">
